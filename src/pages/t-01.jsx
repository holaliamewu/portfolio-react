...
export default function ThoughtOne() {
    return (
      <div className="mx-auto w-[90vw] max-w-[500px] text-sm leading-[1.8] md:leading-[2] text-zinc-500 min-h-[100vh] font-['onest'] flex flex-col md:mt-16  ">
        <HomeButton />
        <SupportMe />
        <h1 className=" text-xl font-[700] text-zinc-800 mt-[50px] mb-1" >coding is not hard: they lied and here is why.</h1>
        <h4 className='flex items-center text-xs gap-1 mb-8' > <CalendarDays size={16} /> 5 april, 2024.</h4>
          <h3 className='p-3 border rounded-lg text-sm text-zinc-800 font-medium mt-4 mb-12'>
        ...
        <h1 className=' text-lg font-semibold text-zinc-800 mt-8 mb-2' >the masses' why</h1>
        ...
        <h1 className=' text-lg font-semibold text-zinc-800 mt-8 mb-2' >the truth</h1>
        <p className='text-justify font-light ' >
        ...
        <h1 className=' text-lg font-semibold text-zinc-800 mt-8 mb-2' >'what do i do' </h1> 
        <p className='text-justify font-light ' >
        ...
        <span className="block my-6 px-2 py-4 pr-6 rounded-lg text-zinc-800 font-medium border-l-teal-400 border  border-l-4" >
        ...
        <h1 className=' text-lg font-semibold text-zinc-800 mt-8 mb-2' >last gold</h1>
        ...
        <h3 className='p-3 border rounded-lg font-medium text-zinc-800 text-md mt-4 mb-12' >  tl;dr: a good foundation in coding is a real game-changer if you want an easy and a fun ride. </h3>
