...
export default function BlogOne() {
    return (
      <div className='' >
        <SupportMe />
        <h1 className=" text-xl font-black mt-[50px] mb-1" >coding is not hard: they lied and this is why.</h1>
        <h4 className='flex items-center text-sm gap-1 mb-8' > <CalendarDays size={18} /> 5 april, 2024.</h4>
          <h3 className='p-3 border rounded-lg font-[600] text-md mt-4 mb-12'>
        ...
        <h1 className=' text-xl font-black mt-8 mb-2' >the masses' why</h1>
