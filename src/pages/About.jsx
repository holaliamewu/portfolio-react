        ...
        <div className=' mx-auto pb-[50px] pt-[10px]  text-[16px]' >
           ...
           <span className='block mx-auto w-fit mt-[60px] mb-[40px] '> 
            ...
            <div className='font-[300] ' >
                ...
                >Akwaaba! [ means Welcome in my Twi ]. I'm Holali, a dev with a growing eye for aesthetics.
                ...
                maintainable code. When I don't have my hands on the keyboard, I'm definitely reading, watching soccer or the <a href="https://www.youtube.com/@sidemenreacts" className="underline italic" target="_blank" >Sidemen</a> [ or the <a href="https://youtube.com/@betasquad/" className="underline italic" target="_blank" >Beta Squad</a> ].
