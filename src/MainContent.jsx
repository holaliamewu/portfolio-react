    ...
    return(
        <main>
            ...
            <div className="project one">
                ...
                a menu that allows you to edit your particulars or preferences and journal that takes in your "plans" for that day.</p> 
                ...
                <p>i'm currently updating the 'settings' part of Umo embrace user expenrience so it will be unavailable for a short while. <i id="linkToUmo" class="fa-solid fa-arrow-up-right-from-square"></i></p>
            </div>
        </main>
    )
}